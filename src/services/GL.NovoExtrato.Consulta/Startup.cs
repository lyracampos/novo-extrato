...
using GL.NovoExtrato.Consulta.Services;
...
namespace GL.NovoExtrato.Consulta
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ExtratoContexto>();
            services.AddScoped<IExtratoRepositorio, ExtratoRepositorio>();
            services.AddScoped<IExtratoServico, ExtratoServico>();
        }
